...
function Footer(props) {
  ...
  // console.log(props);
  return (
    <Box mt={{ss:ss, sm:sm, sl:sl , md:"0"}} bg="white" borderTop="1px" borderColor="gray.200">
            <Flex 
            direction={["column", "column" , "column" , "row" ]}
            justifyContent="space-around"
            >
            <Flex flexDirection="column" ml={{ss:"1em", sm:"1em", sl:"1em" , md:"0"}}>
                <Text fontSize="22px" fontWeight="700" mt="19px">Contact Us</Text>
                ...
                <Flex mt="2em" ml={{ss:"1em", sm:"1em", sl:"1em" , md:"0"}}>
                    ...
                    <Box width="251px" height="70px">
                        <Text fontSize="16px">Lebak Bulus, Jl.RS.Fatmawati Raya No.10, Kota Jakarta Selatan,DKI Jakarta</Text>
                    </Box>
                </Flex>
            </Flex>
