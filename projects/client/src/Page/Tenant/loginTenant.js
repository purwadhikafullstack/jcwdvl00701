    ...
    return (
        <Flex flexDirection="column" bg="black">
            ...
            <Flex>
                {/* utk image dekstop */}
                <Flex>
                    <Image display={{ ss:"none", sm:"none", sl:"none", md:"block", lg:"block"}} src={loginTenant} width="900px" height="1080px"/>
                </Flex>

                {/* Form */}
                <Flex ml={{ss:"14px",sm:"6em",md:"7em", lg:"9em"}} my="3em" bg="black">
                    <Box width="360px" height="297px">
                        ...
                        <Flex justifyContent="center" alignItems="center">
                            <Box width="320px" height="427px">
                                ...
                                <Flex justifyContent="center" border="1px" borderColor="gray.200" mt="20px" bg="white" zIndex={1}>
