    ...
    <Box backgroundColor='white'>
      <Box w="100%" p={4} boxShadow='lg'>
        <Flex justify="space-between" backgroundColor='gray.100' align="center">
          ...
          <IconButton aria-label='toggle filters' icon={<i className="fa-solid fa-filter"/>} backgroundColor='gray.200'
                      m={2}/>
        </Flex>
      </Box>
      ...
      <Box w="100%" p={4} boxShadow='lg' backgroundColor='gray' position='absolute' top={0} zIndex={2}
        ...
        <Flex direction='column'>
          ...
          <Box w='100%' backgroundColor='white' py={3} px={6} my={2} display={!isGuestInputOpen ? 'block' : 'none'}
          ...
          <Box w='100%' backgroundColor='white' my={2}>
            <Button variant="primary" w='100%' leftIcon={<i className="fa-solid fa-magnifying-glass"/>}>Search
              Now</Button>
          </Box>
        </Flex>
      </Box>
